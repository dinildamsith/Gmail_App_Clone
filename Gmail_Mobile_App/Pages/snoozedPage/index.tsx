...
export default function SnoozedPage({ navigation }) {
        ...
        {/* <ScrollView contentContainerStyle={{ flexGrow: 1 }}> */}
          ...
          <View style={{ width: windowWidth, height: windowHeight,backgroundColor:'#fffefe' }}>
            ...
            <View style={{marginTop:10,marginLeft:17}}>
              ...
              <ScrollView>
              <Image
                  source={require('../../assets/images/snozzed.jpeg')}
                  style={{
                    position:'relative',
                    width:250,
                    height:200,
                 ...
                 <Text style={{alignSelf:'center',fontSize:30,marginTop:22,textAlign:'center'}}>Nothing in Snoozed</Text>
              </ScrollView>
            </View>
